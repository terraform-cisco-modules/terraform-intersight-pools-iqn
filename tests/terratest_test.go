...
func TestFull(t *testing.T) {
	...
	instanceName := fmt.Sprintf("test-pools-iqn-%s", uniqueId)
...
`
	...
	iassert.AssertMOComply(t, fmt.Sprintf("/api/v1/iqnpool/Pools/%s", moid), expectedJSONTemplate, vars)
}
